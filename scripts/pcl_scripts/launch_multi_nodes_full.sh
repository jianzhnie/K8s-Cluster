...
# --- 训练相关参数，来自你原始脚本的配置 ---
PROJECT_DIR="/llm_workspace_1P/robin/MindSpeed-LLM"
DATA_PATH="/llm_workspace_1P/robin/hfhub/datasets/tatsu-lab/alpaca/data/train-00000-of-00001-a09b74b3ef9c3b56.parquet"
DATA_DIR="/llm_workspace_1P/robin/hfhub/datasets/tatsu-lab/alpaca/data/"
DATA_NAME_PATTERN="train*"
TOKENIZER_PATH="/llm_workspace_1P/robin/hfhub/models/Qwen/Qwen3-8B"
CKPT_LOAD_DIR="/llm_workspace_1P/robin/hfhub/models/Qwen/Qwen3-8B"
...
# --- 远程脚本和日志配置 ---
OUTPUT_DIR="$PROJECT_DIR/work_dir/pretrain_qwen3_8b_4K_ptd_A3"
...
TRAIN_SCRIPT="$PROJECT_DIR/pcl_scripts/pretrain_qwen3_8b_4K_ptd_A3.sh"
...
launch_nodes() {
    ...
    for i in "${!NODE_HOSTS[@]}"; do
        ...
        ssh \
            ...
            export MG_SAVE_DIR="$MG_SAVE_DIR";
